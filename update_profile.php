...
if(isset($_POST['submit'])){
   ...
   if(!empty($email)){
      ...
      if($select_email->rowCount() > 0){
         $message[] = 'Email hal already been taken!';
      }else{
   ...
   if(!empty($number)){
      ...
      if($select_number->rowCount() > 0){
         $message[] = 'Number has already been taken!';
      }else{
...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" placeholder="<?= $fetch_profile['number']; ?>"" class="box" min="0" max="99999999999" maxlength="12">
